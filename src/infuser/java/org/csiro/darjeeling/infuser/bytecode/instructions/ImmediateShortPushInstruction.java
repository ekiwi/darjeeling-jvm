/*
 * ImmediateShortPushInstruction.java
 * 
...
public class ImmediateShortPushInstruction extends PushInstruction
{

	public ImmediateShortPushInstruction(Opcode opcode, int value)
	{
		super(opcode, value);
	}
