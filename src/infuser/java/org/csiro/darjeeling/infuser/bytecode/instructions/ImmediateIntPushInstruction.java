/*
 * ImmediateIntPushInstruction.java
 * 
...
public class ImmediateIntPushInstruction extends PushInstruction
{

	public ImmediateIntPushInstruction(Opcode opcode, int value)
	{
		super(opcode, value);
	}
