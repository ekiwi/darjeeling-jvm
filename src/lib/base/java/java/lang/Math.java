...
*/
	 ...
	 * 
	 * @param a
	 *            a <code>double</code> value. <!--@return the value
...
*/
	 ...
	 * value, the result is that same value. If either value is <code>NaN</code>
	 * , then the result is <code>NaN</code>. Unlike the the numerical
	 * comparison operators, this method considers negative zero to be strictly
	 * smaller than positive zero. If one argument is positive zero and the
