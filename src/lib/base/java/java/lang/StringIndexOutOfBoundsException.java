...
/**
 * Thrown by the <code>charAt</code> method in class <code>String</code> and by
 * other <code>String</code> methods to indicate that an index is either
...
public class StringIndexOutOfBoundsException extends IndexOutOfBoundsException
{
	...
	{
		// Todo commenting this out. To avoid 1KB of size
